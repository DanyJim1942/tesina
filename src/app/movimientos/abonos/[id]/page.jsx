    ...
    <>
      ...
      <div>
        <div id="altaswrapper" className="">
          ...
          <div
            id="altascontenedor0"
            className="p-2 m-2 border-4 border-emerald-900 bg-emerald-950 flex ">
            {/* FORMULARIO */}
            <form onSubmit={handleSubmit} className="  flex flex-col">
              ...
              {/*DIV - ABONOS */}
              <div id="altaspersona" className="grid grid-cols-3 gap-6 place-items-center">
                  {/*DIV - ABONO 1 -DATO */}
                  <div className="m-2 gap-2 flex">
                    <label htmlFor="">Abono 1</label>
                    <input
                      onChange={(e) => abono1set(e.target.value)}
                      value={abono1}
                      type="text"
                      id="abono1"
                      placeholder={venta.abono1}
                      className="bg-slate-500"
                    />
                  </div>
                  {/*DIV - ABONO 2 -DATO */}
                  <div className="m-2 gap-2 flex">
                    <label htmlFor="">Abono 2</label>
                    <input
                      onChange={(e) => abono2set(e.target.value)}
                      value={abono2}
                      type="text"
                      id="abono2"
                      placeholder={venta.abono2}
                      className="bg-slate-500"
                    />
                  </div>
                  {/*DIV - ABONO 3 -DATO */}
                  <div className="m-2 gap-2 flex">
                    <label htmlFor="">Abono 3</label>
                    <input
                      onChange={(e) => abono3set(e.target.value)}
                      value={abono3}
                      type="text"
                      id="abono3"
                      placeholder={venta.abono3}
                      className="bg-slate-500"
                    />
                  </div>
                </div>
